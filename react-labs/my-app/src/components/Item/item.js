...
function Item(){
    ...
    const handle = (id, horsepower, price, image_uri) => dispatch(addCar({id, horsepower, price, image_uri, amount: 1}))
    useEffect(() => {
        setTimeout(() => {
            setLoading(false)
        }, 1000)
                ...
                <div className="item-page">
                    ...
                    <div className="item-page__bottom">
                        ...
                        <div className="item-page__bottom__buttons">
                            ...
                            <Button onClick={() => handle(car.id, car.horsepower, car.price, car.image_uri)} style={{width: 180}} variant="light">Add to cart</Button>
                        </div>
                    </div>
                </div>
            )}
